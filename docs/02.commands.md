...
while you can make commands without Hikari, command clients makes it a lot easier
...
![slash_command_example_1](./images/slash_command_example_1.png){ width=49% }
![slash_command_example_2](./images/slash_command_example_2.png){ width=49% }
...
![message_menu_example](./images/message_menu_example.png)
...
![user_menu_example](./images/user_menu_example.png){ width=40% }
